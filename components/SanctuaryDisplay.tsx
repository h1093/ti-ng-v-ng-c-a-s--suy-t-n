...
const SanctuaryDisplay: React.FC<SanctuaryDisplayProps> = ({ sanctuary, onAction }) => {
                                ...
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm">
                                            Lòng Trung Thành: <span className="font-semibold text-yellow-400">{f.loyalty}</span>
                                        </p>
                                        <p className="text-gray-400 text-sm">
                                            Trạng Thái: <span className="italic">{f.status}</span>
                                        </p>
                                    </div>
...
export default SanctuaryDisplay;
