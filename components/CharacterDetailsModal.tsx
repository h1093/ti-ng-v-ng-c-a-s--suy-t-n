...
import type { Character, Sanctuary } from '../types';
...
type DetailsTab = 'inventory' | 'proficiency' | 'faith' | 'sanctuary';



const CharacterDetailsModal: React.FC<CharacterDetailsModalProps> = ({ character, onClose, onSanctuaryAction }) => {
    
    const TABS: { key: DetailsTab; label: string, show: boolean }[] = [
    ...
    const [activeTab, setActiveTab] = useState<DetailsTab>('inventory');
